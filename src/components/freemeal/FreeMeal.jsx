  ...
  return (
    ...
    <div className='flex flex-col lg:flex-row space-x-3 items-center space-y-10'>
      ...
      <div>
        ...
        <h1 className='text-xl sm:text-5xl font-black font-secondary text-para leading-[1.25]'>Get Your Free Food From KX2 Now!</h1>
      </div>
      <div>
        <p className='sm:text-lg text-[14px] font-medium text-[#333333]'>If you are poor or unable to pay KX2 for food you can get free meal by ordering us.</p>
